...
## 16. Manage Time Zone
- TIMESTAMP: DATE plus fractional sec
- TIMESTAMP WITH TIME ZONE: time zone region name/offset
- TIMESTAMP WITH LOCAL TIME ZONE: normalized to the databse time zone, retrieved as local session tz
- TIMESTAMP fields:
  - YEAR
  - MONTH
  - DAY
 ...
 - functions
   ...
   - INTERVAL DAY TO SECOND
   - EXTRACT: field
   - FROM_TZ: convert TIMESTAMP TO TIMESTAMP WITH TIME ZONE
   - NUMTOYMINTERVAL
   - SYS_EXTRACT_UTC: get UTC
   - TO_DSINTERVAL
   - TO_TIMESTAMP
   - TO_TIMESTAMP_TZ
   - TO_YMINTERVAL
...
--07-MAY-17	07-MAY-17	07-MAY-17 06.57.30.007823 PM US/PACIFIC	07-MAY-17 06.57.30.007823 PM

SELECT FROM_TZ(TIMESTAMP'2017-05-25 12:00:00', 'US/Central') FROM dual;
